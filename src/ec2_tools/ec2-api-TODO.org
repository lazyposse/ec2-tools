#+title: API EC2
#+author: Denis Labaye, Antoine R. Dumont
...
* DONE Fix the setup inside the ec2-tools/ec2-query namespace
CLOSED: [2012-10-04 jeu. 08:19]
* DONE Separate the concerns between the ec2-query and the hook managing.
CLOSED: [2012-10-04 jeu. 08:27]
* DONE Improve the hook mechnism
CLOSED: [2012-10-04 jeu. 18:59]
